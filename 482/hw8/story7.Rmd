...
<!-- # ```{r} -->
<!-- # # Install apaTables package if not installed -->
<!-- # # install.packages("apaTables") -->
<!-- #  -->
<!-- # # Load required libraries -->
<!-- # library(apaTables) -->
<!-- #  -->
<!-- # # Create a sample dataset with two factors (A and B) -->
<!-- # set.seed(123) -->
<!-- # data <- data.frame( -->
<!-- #   A = rep(c("Level1", "Level2", "Level3"), each = 10), -->
<!-- #   B = rep(c("Factor1", "Factor2"), each = 15), -->
<!-- #   Response = rnorm(30) -->
<!-- # ) -->
<!-- #  -->
<!-- # # Fit the ANOVA model -->
<!-- # model <- aov(Response ~ A * B, data = data) -->
<!-- #  -->
<!-- # # Create an ANOVA results table in LaTeX format -->
<!-- # anova_table <- apa.aov.table(model, file = "") -->
<!-- #  -->
<!-- # # Print the LaTeX code for the table -->
<!-- # cat(anova_table, file = "anova_table.tex") -->
<!-- # ``` -->
