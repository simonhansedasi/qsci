...
```{r}
welch_on <- t.test(old$movement, young$movement, var.equal = TRUE)
welch_off <- t.test(old$movement, young$movement, var.equal = FALSE)
...
a.  By decreasing confidence the graduate student reduced the possibility of encountering a type 1 error of rejecting the null hypothesis when it is actually true.
